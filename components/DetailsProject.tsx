      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full h-[600px] px-4 py-10 flex flex-col items-center justify-center">
          <RoughNotation
            ...
            iterations={3}
          >
            <h2 className="p-2 text-4xl font-bold text-[#f5cb5c] text-center">
              {project.name}
            </h2>
          </RoughNotation>
          <p className="text-[#cfdbd5] max-w-[140ch] font-medium text-lg my-6">
            {project.description}
          </p>
        ...
        <div className="relative w-full px-4 pt-36 pb-10">
          <h2 className="text-2xl font-bold text-[#f5cb5c] text-center mb-10">
            Contribuidores
          </h2>
          <div className="grid grid-cols-2 xl:grid-cols-3 gap-5 justify-items-center max-w-[1240px] mx-auto">
            {project.contributors.map((el, idx) => {
              return (
                <div
                  key={idx}
                  className="w-48 md:w-72 ring-2 ring-[#242423]/[33] shadow-lg p-4 rounded transition-all hover:ring-[#f5cb5c]/[50]"
                >
                  ...
                  <Link
                    href={el.profile}
                    target="_blank"
                    className="text-[#cfdbd5] font-medium transition-all hover:underline"
                  >
                    Ir al Perfil
                  </Link>
                </div>
